...
HOST = "mqtt"
PORT = 1883
client_id = str(floor(random.random()*1000000)) # 没有就不写，此处部分内容用xxx代替原内容，下同
...
data = {
    "type":2,
    "timestamp": time.time(),
    "messageId":"9fcda359-89f5-4933-"+str(floor(random.random()*1000)),
...
client.subscribe("data/send", qos=2)
client.loop_forever()
